...
-- 正在导出表  mall_pms.pms_sku 的数据：~0 rows (大约)
...
INSERT INTO `pms_sku` (`id`, `spu_id`, `title`, `bar_code`, `attribute_template_id`, `specifications`, `album_id`, `pictures`, `price`, `stock`, `stock_threshold`, `sales`, `comment_count`, `positive_comment_count`, `sort`, `gmt_create`, `gmt_modified`) VALUES
	(1, 2, '2021年新款，小米11 Ultra黑色512G，16G超大内存120Hz高刷67w快充', NULL, 1, '{"attributes":[{"id":1,"name":"屏幕尺寸","value":"6.1寸"},{"id":3,"name":"颜色","value":"黑色"},{"id":5,"name":"运行内存","value":"16GB"}]}', NULL, 'http://localhost:9060/1.PNG', 6999.99, 877, 50, 0, 0, 0, 0, NULL, '2022-05-16 16:46:09'),
	(2, 2, '2021年新款，小米11 Ultra白色512G，8G超大内存120Hz高刷67w快充', NULL, 1, '{"attributes":[{"id":1,"name":"屏幕尺寸","value":"6.1寸"},{"id":3,"name":"颜色","value":"白色"},{"id":5,"name":"运行内存","value":"8GB"}]}', NULL, 'http://localhost:9060/1.PNG', 6499.99, 740, 50, 0, 0, 0, 0, NULL, '2022-05-16 16:49:23'),
...
-- 正在导出表  mall_pms.pms_sku_specification 的数据：~0 rows (大约)
...
-- 正在导出表  mall_pms.pms_spu 的数据：~0 rows (大约)
...
INSERT INTO `pms_spu` (`id`, `name`, `type_number`, `title`, `description`, `list_price`, `stock`, `stock_threshold`, `unit`, `brand_id`, `brand_name`, `category_id`, `category_name`, `attribute_template_id`, `album_id`, `pictures`, `keywords`, `tags`, `sales`, `comment_count`, `positive_comment_count`, `sort`, `is_deleted`, `is_published`, `is_new_arrival`, `is_recommend`, `is_checked`, `check_user`, `gmt_check`, `gmt_create`, `gmt_modified`) VALUES
	(1, 'iPhone 13', 'A2404', '苹果手机iPhone 13（A2404）', '2021年新款，全网首发', 5690.00, 5000, 20, '部', 3, '苹果', 3, '智能手机', NULL, NULL, 'http://localhost:9060/0.PNG', 'ip13,iPhone13,苹果13', '20w快充,NFC,无线充电', 0, 0, 0, 0, 0, 1, 0, 0, 1, NULL, NULL, '2022-03-31 11:16:33', '2022-03-31 15:22:33'),
...
-- 正在导出表  mall_pms.pms_spu_detail 的数据：~0 rows (大约)
